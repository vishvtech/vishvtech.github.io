	...
	return (
		...
		>
			...
			<ScrollAnimation className="text-center mb-16">
				<h2
					id="about-title"
					className="heading-secondary text-accent-glow mb-6"
				>
					Who We Are
				</h2>
				<div className="max-w-4xl mx-2 sm:mx-0">
					<p className="text-enhanced leading-relaxed">
						VishvTech is founded by a passionate team of students and researchers
						from the Mechatronics Lab at IIT Indore. With a shared vision of
						bridging technology and innovation, we strive to deliver impactful
						solutions for industries and individuals alike.
					</p>
				</div>
			</ScrollAnimation>
        ...
        {teamMembers.map((member, index) => (
          <ScrollAnimation key={member.name} delay={index * 100}>
			...
			<ScrollAnimation className="text-center mt-16" delay={600}>
				<div className="scan-overlay rounded-xl p-8 bg-card/30 backdrop-blur-sm border border-border/30 neon-border mx-2 sm:mx-0">
					<h3 className="text-xl font-bold text-accent-glow mb-4">
						Ready to Work with Us?
					</h3>
					<p className="text-enhanced mb-6 max-w-2xl mx-auto">
						Let's collaborate on your next innovative project. Our team is ready to
